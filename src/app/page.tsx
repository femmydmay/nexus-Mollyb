...
export default async function Home() {
  const listings = ((await getData()) as Listing[]) || [];
      ...
      <main className="bg-white/95">
                ...
                <div className="">
                  <Products
                    item={
                      listings.filter(
                        (list) =>
                          list.advert_type === "for sale" && list.TopListings
                      ) as any
                    }
                ...
                <div className="">
                  <Products
                    item={
                      listings.filter(
                        (list) =>
                          list.advert_type === "for rent" && list.TopListings
                      ) as any
                    }
        ...
        <div className="w-11/12 grid mx-auto py-20 w-full h-full gap-9s z-10 bg-[#f7f9fc]">
          <section className="w-full">
            ...
            <article className="text-slate-900 text-xl text-center leading-[3rem]">
              ...
              In our experience, the best way to manage uncertainty is to arm
              yourself with knowledge! <br />
              We provide small pieces of information to prepare you for each
              step of your home selling journey.
              <br /> For even more in-depth information, check out our Buy and
              sell pages.
            </article>
        ...
        <section className="min-h-[60vh] w-10/12   mx-auto py-24 lg:py-28 overflow-hidden">
          <h2 className="text-slate-800 font-bold mt-20 uppercase mb-20  text-[1.5rem] font-cde text-center">
            ...
            <br /> with the Lord recently. She was a Lover of art and artist
            <br />
            herself. These are some of her works below. <br /> The art works are
            for sale, please order yours.
            <br />
            They come with frames.<br /> Call or Whatsapp 0818-569-6269 for price and other art works.
          </h2>

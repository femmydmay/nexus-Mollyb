    ...
    <MainLayout>
      <main className="bg-blue-1000 ">
        <section className="relative bg-[url(https://images.unsplash.com/photo-1604014237800-1c9102c219da?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80)] bg-cover bg-center bg-no-repeat">
          <div className="absolute inset-0 bg-white/25  sm:from-white/90 sm:to-white/25 sm:bg-gradient-to-r  h-full w-full "></div>
          ...
          <div className="container px-6 py-12 mx-auto">
            <div>
              ...
              <h1 className="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">
                Chat to our friendly team at Nexus Classic Properties
              </h1>
            ...
            <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
              ...
              <div className="p-4 py-6 rounded-lg   border md:p-8">
                <form>
                  ...
                  <div className="mt-4">
                    ...
                    <input
                      type="email"
                      placeholder="Type correct email address"
                      className="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                    />
                  </div>
